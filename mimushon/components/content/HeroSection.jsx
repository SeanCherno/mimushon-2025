    ...
    >
        ...
        <div className="container mx-auto px-6 text-center relative">
            ...
            <div className="mt-5 md:flex md:flex-cols md:justify-center text-center">
                ...
                <a href="#calculation-exp" className="mt-3 md:mt-8 w-60 mx-2 inline-block bg-gray-100 hover:bg-indigo-200 text-indigo-800 font-bold py-3 px-8 rounded-lg text-sm sm:text-lg transition duration-300 border border-indigo-700">איך עובד החישוב</a>
            </div>
