        ...
        <>
            ...
            <div className="py-12 sm:py-16 bg-indigo-50">
                <div className="container mx-auto px-6 max-w-4xl bg-white p-8 sm:p-12 rounded-lg shadow-md">
                    ...
                    <p className="text-sm text-gray-500 text-center mb-10">עדכון אחרון: 9 באוגוסט 2026</p>
                    ...
                    <div className="prose prose-lg max-w-none text-right">
                        ...
                        <p>האתר עשוי להשתמש ב"עוגיות" (Cookies) לצורך תפעולו השוטף והתקין, ובכלל זה כדי לאסוף נתונים סטטיסטיים אודות השימוש באתר ולשיפור חווית הגלישה. לצורך הניתוח הסטטיסטי אנו נעזרים בשירות Google Analytics של חברת Google, אשר עשוי לעשות שימוש בעוגיות ולאסוף מידע אנונימי על אופן השימוש באתר (כגון דפים שנצפו וסוג הדפדפן), בהתאם למדיניות הפרטיות של Google. מידע זה אינו כולל את פרטיכם האישיים המזהים. באפשרותכם להימנע מקבלת עוגיות על ידי שינוי ההגדרות בדפדפן שלכם.</p>
