            ...
            <div className="py-12 sm:py-16 bg-indigo-50">
                <div className="container mx-auto px-6 max-w-4xl bg-white p-8 sm:p-12 rounded-lg shadow-md">
                    ...
                    <div className="prose prose-lg max-w-none text-right">
                        ...
                        <h2>5. קניין רוחני</h2>
                        <p>כל זכויות הקניין הרוחני באתר, לרבות עיצובו, קוד המקור, התכנים והמחשבון, שייכות במלואן ל"זכותי עכשיו". אין להעתיק, להפיץ, לשכפל או לעשות שימוש מסחרי כלשהו בתכני האתר ללא קבלת אישור מראש ובכתב.</p>
