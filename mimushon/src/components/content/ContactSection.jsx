            ...
            <div className="max-w-xl mx-auto mt-10">
                ...
                {success === false && <div className="bg-red-300 font-semibold text-slate-900 rounded-lg mb-3 text-center">
                    ...
                    <div className="text-center">
                        <button onClick={(e) => handleUserInfoSubmit(e)} className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-8 rounded-lg text-lg w-full transition duration-300" type="submit">
