        ...
        <div className="container mx-auto px-6 max-w-4xl bg-white p-8 sm:p-12 rounded-lg shadow-md">
          <div className="prose prose-lg max-w-none text-right">
            ...
            <p>
              ...
              <strong>לפשט תהליך אחד, מורכב ומתסכל - חישוב אחוזי נכות.</strong>
            </p>
            <p>
            ...
            <blockquote>
              <p>
                ...
                ואינם תחליף לייעוץ מקצועי פרטני. התוצאות במחשבון הן{" "}
                <strong>הערכה בלבד</strong> ואינן מחייבות שום גורם רשמי.
              </p>
            </blockquote>
