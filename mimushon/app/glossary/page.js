...
const TERMS = [
  ...
  },
  {
    ...
    anchor: "takana-15",
    explanation:
      "מנגנון חוקי בענף נפגעי עבודה המאפשר להגדיל את הנכות הרפואית בעד 50% נוספים, אם הפגיעה מונעת מהנפגע לחזור לעבודתו הספציפית ואין לו יכולת השתכרות חלופית. חל אך ורק על נפגעי עבודה — לא על נכות כללית. כאשר האחוז שנקבע הוא מתחת ל-20%, החוק קובע שהתוספת לא תעלה על 19% — כלומר לא ניתן להשתמש בתקנה זו כדי לחצות את סף ה-20% ולהפוך מענק חד-פעמי לקצבה חודשית.",
    related: ["takana-18"],
  },
  {
