        ...
        <div className="container mx-auto px-6 max-w-4xl bg-white p-8 sm:p-12 rounded-lg shadow-md">
          <div className="prose prose-lg max-w-none text-right">
            ...
            <ul className="list-disc space-y-2">
              ...
              <li>נקבעו 14% → תקנה 15 יכולה להעלות ל-20% ויותר, מה שפותח זכאות לקצבה חודשית במקום מענק חד-פעמי.</li>
            </ul>

            <div className="tip-box">
              <strong>💡 למה זה כל כך חשוב?</strong> הסף לקצבה חודשית לנפגעי עבודה הוא 20%. מי שנקבעו לו 14% ואינו יכול לחזור לעבודה — אם תקנה 15 מעלה אותו ל-20% ומעלה, הוא עובר ממענק חד-פעמי לקצבת חיים. ההבדל יכול להיות מאות אלפי שקלים לאורך שנים.
            </div>
